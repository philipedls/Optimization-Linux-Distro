 ...
 * Clear the cache only:
  ...
  ˋˋˋ # sync; echo 1 > /proc/sys/vm/drop_caches ˋˋˋ
  
 * Clean dentries and inodes:
 
  ˋˋˋ # sync; echo 2 > /proc/sys/vm/drop_caches ˋˋˋ
  
  * Clear cache, dentries and inodes:
 
  ˋˋˋ # sync; echo 3 > /proc/sys/vm/drop_caches ˋˋˋ
 
 Add permission to the file:
 
 ˋˋˋ chmod 777 /path_to_file/namefile.sh ˋˋˋ
 Or
 
 ˋˋˋ chmod +x /path_to_file/namefile.sh ˋˋˋ
 ...
 Understanding all the commands above and especially the risk of using the third command, I created the following ShellScript file:
  ˋˋˋ !/bin/bash
  sync; echo 3 > /proc/sys/vm/drop_caches ˋˋˋ 
...
#### Using CPUFreq to increase performance or to increase processor powersave
 ...
 ˋ sudo apt install cpufrequtils indicator-cpufreqˋ
